...
df_agri$year <- 2014
df_agri$prev_year <- 2011
df_urb$year <- 2014
df_urb$prev_year <- 2011
df_selva$year <- 2014
df_selva$prev_year <- 2011


df_agri$area_year <- df_agri$area/(0.0+(df_agri$year - df_agri$prev_year))
df_urb$area_year <- df_urb$area/(0.0+(df_urb$year - df_urb$prev_year))
df_selva$area_year <- df_selva$area/(0.0+(df_selva$year - df_selva$prev_year))
...
file <- "/home/fidel/cambio_cobertura_ca/v5_aptitud_evidence/modulate_tm_2011_2014.csv"
