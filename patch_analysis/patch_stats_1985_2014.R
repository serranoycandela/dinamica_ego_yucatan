...
df_agri <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/agro_s5_s6_new_patches_result.dbf")
df_urb <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/urb_s5_s6_new_patches_result.dbf")
df_selva <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/selva_s5_s6_new_patches_result.dbf")



df1 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/agro_s1_s3_new_patches_result.dbf")
df2 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/agro_s3_s5_new_patches_result.dbf")
df3 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/agro_s5_s6_new_patches_result.dbf")

df4 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/urb_s1_s3_new_patches_result.dbf")
df5 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/urb_s3_s5_new_patches_result.dbf")
df6 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/urb_s5_s6_new_patches_result.dbf")

df7 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/selva_s1_s3_new_patches_result.dbf")
df8 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/selva_s3_s5_new_patches_result.dbf")
df9 <- read.dbf("/home/fidel/cambio_cobertura_ca/v4_aptitud_evidence/patch_analysis/result/selva_s5_s6_new_patches_result.dbf")
...
df9$area_year <- df9$area/(0.0+(df9$year - df9$prev_year))

df_agri <- rbind(df1, df2, df3)
df_urb <- rbind(df4, df5, df6)
df_selva <- rbind(df7, df8, df9)
...
file <- "/home/fidel/cambio_cobertura_ca/v5_aptitud_evidence/modulate_tm.csv"
...
file <- "/home/fidel/cambio_cobertura_ca/v5_aptitud_evidence/expander_parameters.csv"
...
file <- "/home/fidel/cambio_cobertura_ca/v5_aptitud_evidence/patcher_parameters.csv"
